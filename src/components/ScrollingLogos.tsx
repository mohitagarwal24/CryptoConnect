...
const ScrollingLogos = () => {
  ...
  return (
    <div className="relative w-full bg-gray-50 py-16 overflow-hidden z-auto"> 
      ...
      <div className="absolute left-0 top-0  h-full w-[200px] bg-gradient-to-r from-gray-50 to-transparent z-auto"></div>
      <div className="absolute right-0 top-0 h-full w-[200px] bg-gradient-to-l from-gray-50 to-transparent z-auto"></div>

      {/* Scrolling container */}
      <div className="animate-scroll flex items-center space-x-16 w-max z-auto">
        {doubledLogos.map((Logo, index) => (
          <div
            key={index}
            className="mx-6 flex h-28 w-28 flex-shrink-0 items-center justify-center rounded-full bg-white shadow-lg z-auto"
          >
